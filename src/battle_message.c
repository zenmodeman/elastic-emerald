...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_DRAINDOUSESETSDRAINING - BATTLESTRINGS_TABLE_START] =  COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}'s liquid gives its moves draining!"),
    [STRINGID_DRAINEDWITHLIQUID - BATTLESTRINGS_TABLE_START] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} drained energy with its liquid!"),
