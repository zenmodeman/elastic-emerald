...
static const u8 sText_MudSportPreventsParalysis[] = _("{B_DEF_NAME_WITH_PREFIX} is not affected\nthanks to the mud!");
static const u8 sText_WaterSportPreventsBurn[] = _("{B_DEF_NAME_WITH_PREFIX} is not affected\nthanks to the water!");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_MUDSPORTPREVENTS - BATTLESTRINGS_TABLE_START] = sText_MudSportPreventsParalysis,
    [STRINGID_WATERSPORTPREVENTS - BATTLESTRINGS_TABLE_START] = sText_WaterSportPreventsBurn,
