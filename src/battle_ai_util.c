...
{
    if (((!IsMoldBreakerTypeAbility(battlerAtk, AI_DATA->abilities[battlerAtk]) && (defAbility == ABILITY_SHIELD_DUST || defAbility == ABILITY_COVERED || defAbility == ABILITY_INNER_FOCUS))
...
bool32 ShouldFakeOut(u32 battlerAtk, u32 battlerDef, u32 move)
{
    ...
    && (AI_DATA->abilities[battlerDef] == ABILITY_SHIELD_DUST || AI_DATA->abilities[battlerDef] == ABILITY_COVERED || AI_DATA->abilities[battlerDef] == ABILITY_INNER_FOCUS)))
        return FALSE;
