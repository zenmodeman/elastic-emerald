...
bool32 IsMoveIneffective(u32 move, u32 battlerAtk, u32 battlerDef){
    ...
    if (CanAbilityBlockMove(battlerAtk, battlerDef, move, AI_DATA->abilities[battlerDef], FALSE)){
        return TRUE;
    }
...
{
    if (((!IsMoldBreakerTypeAbility(battlerAtk, AI_DATA->abilities[battlerAtk]) && (defAbility == ABILITY_SHIELD_DUST || defAbility == ABILITY_FUR_LAYER || defAbility == ABILITY_INNER_FOCUS))
...
bool32 ShouldFakeOut(u32 battlerAtk, u32 battlerDef, u32 move)
{
    ...
    && (AI_DATA->abilities[battlerDef] == ABILITY_SHIELD_DUST || AI_DATA->abilities[battlerDef] == ABILITY_FUR_LAYER || AI_DATA->abilities[battlerDef] == ABILITY_INNER_FOCUS)))
        return FALSE;
...
bool32 ShouldRecover(u32 battlerAtk, u32 battlerDef, u32 move, u32 healPercent)
{
    ...
    if (AI_DATA->hpPercents[battlerAtk] < 65 && AI_RandLessThan(127)){
        return TRUE;
    }
    return FALSE;
}
