...
static void CB2_LoadEggHatch(void)
{
    ...
    case 3:
    {
        u32 species = GetMonData(&gParties[B_TRAINER_PLAYER][sEggHatchData->eggPartyId], MON_DATA_SPECIES);
...
static void CB2_EggHatch(void)
{
    ...
    case 13:
        ...
        if (!IsTextPrinterActiveOnWindow(sEggHatchData->windowId) && JOY_NEW(A_BUTTON | B_BUTTON))
        {
