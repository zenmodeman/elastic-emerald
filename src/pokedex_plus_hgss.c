    ...
    for (i = 0; i < times; i++)
    {
        ...
        for (j = 0; evolutions[i].params != NULL && evolutions[i].params[j].condition != CONDITIONS_END; j++)
        {
            ...
            case IF_MIN_RESTRICTED_LEVEL:
                StringAppend(gStringVar4, COMPOUND_STRING("Restricted Mode {LV}"));
                ConvertIntToDecimalStringN(gStringVar2, evolutions[i].params[j].arg1, STR_CONV_MODE_LEFT_ALIGN, 3);
                StringAppend(gStringVar4, gStringVar2);
                StringAppend(gStringVar4, COMPOUND_STRING("+"));
                break;
            case IF_MONOTYPE_MATCHES_ONE_OF_TWO_TYPES:
                ...
                else
                {
                    ...
                    StringAppend(gStringVar4, COMPOUND_STRING("Monotype: "));
                    StringAppend(gStringVar4, gTypesInfo[evolutions[i].params[j].arg1].name);
                    StringAppend(gStringVar4, COMPOUND_STRING(" or "));
                    StringAppend(gStringVar4, gTypesInfo[evolutions[i].params[j].arg2].name);
                }
                break;
            case CONDITIONS_END:
                break;
