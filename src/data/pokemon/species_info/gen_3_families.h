...
const struct SpeciesInfo gSpeciesInfoGen3[] =
{
    ...
    [SPECIES_BEAUTIFLY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SWARM, ABILITY_WIND_RIDER, ABILITY_RIVALRY },
    ...
    [SPECIES_TAILLOW] =
    {
        ...
        .baseDefense   = 30,
        .baseSpeed     = 85,
        .baseSpAttack  = 45, //+15 Sp.Atk, since Swellow got a Sp.Atk buff
        .baseSpDefense = 30,
...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_LOUDRED] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_FIELD),
        .abilities = { ABILITY_SOUNDPROOF, ABILITY_DOMINATE, ABILITY_SCRAPPY },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_CHINGLING] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_CHIMECHO, CONDITIONS({IF_MIN_FRIENDSHIP, FRIENDSHIP_EVO_THRESHOLD},{IF_TIME, TIME_NIGHT}, {IF_MIN_RESTRICTED_LEVEL, 18})}),
    },
#endif //P_GEN_4_CROSS_EVOS
