...
const struct SpeciesInfo gSpeciesInfoGen5[] =
{
    ...
    [SPECIES_SNIVY] =
    {
        ...
        .abilities = { ABILITY_OVERGROW, ABILITY_NONE, ABILITY_LIMBER },
    ...
    [SPECIES_SERPERIOR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_GRASS),
        .abilities = { ABILITY_OVERGROW, ABILITY_NONE, ABILITY_COVERED},
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_ROGGENROLA] =
    {
        ...
        .abilities = { ABILITY_STURDY, ABILITY_WEAK_ARMOR, ABILITY_SOLAR_CORE },
    #else
    ...
    [SPECIES_GIGALITH] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
    #if P_UPDATED_ABILITIES >= GEN_7
        .abilities = { ABILITY_STURDY, ABILITY_SAND_STREAM, ABILITY_SOLAR_CORE },
    #else
        .abilities = { ABILITY_STURDY, ABILITY_NONE, ABILITY_SAND_FORCE },
    #endif
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_WOOBAT] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_SWOOBAT, CONDITIONS({IF_MIN_FRIENDSHIP, FRIENDSHIP_EVO_THRESHOLD}, {IF_MIN_RESTRICTED_LEVEL, 18})}),
    },
...
#define COTTONEE_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_GRASS)
    ...
    [SPECIES_DWEBBLE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 32, SPECIES_CRUSTLE}),
    },
    ...
    [SPECIES_GOTHORITA] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
    #if P_UPDATED_ABILITIES >= GEN_6
        .abilities = { ABILITY_ASTRAL_CHARGE, ABILITY_COMPETITIVE, ABILITY_SHADOW_TAG },
    #else
        .abilities = { ABILITY_ASTRAL_CHARGE, ABILITY_NONE, ABILITY_SHADOW_TAG },
    #endif
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_KLANG] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 39, SPECIES_KLINKLANG}),
    },
