...
#define BLASTOISE_SP_DEF (P_UPDATED_STATS >= GEN_2 ? 105 : 85)
    ...
    [SPECIES_PIDGEY] =
    {
        ...
        .abilities = { ABILITY_KEEN_EYE, ABILITY_BIG_PECKS, ABILITY_COVERED },
    #else
...
#define PIKACHU_SP_DEF (P_UPDATED_STATS >= GEN_6 || P_UPDATED_STATS == GEN_1 ? 50 : 40)
    ...
    [SPECIES_WIGGLYTUFF] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY),
    #if P_UPDATED_ABILITIES >= GEN_6
        .abilities = { ABILITY_CUTE_CHARM, ABILITY_COMPETITIVE, ABILITY_COVERED },
    #else
    ...
    #if P_GEN_2_CROSS_EVOS
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_CROBAT, CONDITIONS({IF_MIN_FRIENDSHIP, FRIENDSHIP_EVO_THRESHOLD}, {IF_MIN_RESTRICTED_LEVEL, 30})}),
    #endif
    },
    ...
    [SPECIES_GOLDUCK] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_FIELD),
        .abilities = { ABILITY_MYSTIC, ABILITY_CLOUD_NINE, ABILITY_SWIFT_SWIM },
        .bodyColor = BODY_COLOR_BLUE,
...
#define GENGAR_SP_DEF (P_UPDATED_STATS >= GEN_2 ? 75 : 130)
    ...
    [SPECIES_GOLDEEN] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 26, SPECIES_SEAKING}),
    },
    ...
    [SPECIES_MAGIKARP] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 20, SPECIES_GYARADOS, CONDITIONS({IF_MONOTYPE_MATCHES_ONE_OF_TWO_TYPES, TYPE_WATER, TYPE_FLYING})}),
    },
