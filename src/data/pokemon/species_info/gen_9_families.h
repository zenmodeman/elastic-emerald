...
const struct SpeciesInfo gSpeciesInfoGen9[] =
{
    ...
    [SPECIES_PAWMO] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_PAWMOT, CONDITIONS({IF_MIN_OVERWORLD_STEPS, 1000}, {IF_MIN_RESTRICTED_LEVEL, 25})}),
    },
    ...
    [SPECIES_BRAMBLIN] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_BRAMBLEGHAST, CONDITIONS({IF_MIN_OVERWORLD_STEPS, 1000}, {IF_MIN_RESTRICTED_LEVEL, 25})}),
    },
    ...
    [SPECIES_RELLOR] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_RABSCA, CONDITIONS({IF_MIN_OVERWORLD_STEPS, 1000}, {IF_MIN_RESTRICTED_LEVEL, 20})}),
    },
