...
const struct SpeciesInfo gSpeciesInfoGen6[] =
{
    ...
    [SPECIES_FLETCHLING] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 17, SPECIES_FLETCHINDER, CONDITIONS({IF_MONOTYPE_MATCHES_ONE_OF_TWO_TYPES, TYPE_FIRE, TYPE_FLYING})}),
    },
...
#define FURFROU_MISC_INFO(_form, _noFlip, frontWidth, frontYOffset, backWidth, backYOffset, _iconIdx)   \
    {                                                                                                   \
        ...
        .growthRate = GROWTH_MEDIUM_FAST,                                                               \
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),                                                   \
        .abilities = { ABILITY_FUR_COAT, ABILITY_NONE, ABILITY_COVERED },                                  \
        .bodyColor = BODY_COLOR_WHITE,                                                                  \
        .noFlip = _noFlip,                                                                              \
...
#define AEGISLASH_MAIN_STAT (P_UPDATED_STATS >= GEN_8 ? 140 : 150)
    ...
    [SPECIES_CLAUNCHER] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 31, SPECIES_CLAWITZER}),
    },
    ...
    [SPECIES_NOIBAT] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 35, SPECIES_NOIVERN}), //Lower by 13 levels
    },
