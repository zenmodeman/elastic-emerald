...
static const struct LevelUpMove sVenusaurLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(12, MOVE_RAZOR_LEAF),
    LEVEL_UP_MOVE(15, MOVE_SLEEP_POWDER),
    LEVEL_UP_MOVE(19, MOVE_VENOSHOCK), //Level-up move addition
    LEVEL_UP_MOVE(22, MOVE_TAKE_DOWN),
    LEVEL_UP_MOVE(25, MOVE_MAGICAL_LEAF),
    LEVEL_UP_MOVE(28, MOVE_LEECH_SEED),
    LEVEL_UP_MOVE(31, MOVE_SYNTHESIS),
    ...
    LEVEL_UP_MOVE(57, MOVE_CURSE), //Level-up move addition, from egg move
...
static const struct LevelUpMove sCharmeleonLevelUpLearnset[] = {
    ...
    // WIP 2
    LEVEL_UP_MOVE(31, MOVE_FLAMETHROWER), // Lv.30 is the SV level, so make it somewhere close to there.
