...
const struct Berry gBerries[NUM_BERRIES + 1] =
{
    ...
    [BERRY_ID_CHERI] =
    {
        .info = {
            ...
            .size = 20,
            .maxYield = YIELD_RATE(12, 5, 15, 20),
            .minYield = YIELD_RATE(8, 2, 4, 4),
    ...
    [BERRY_ID_LEPPA] =
    {
        .info = {
            ...
            .color = BERRY_COLOR_RED,
            .size = 28,
            .maxYield = YIELD_RATE(12, 5, 15, 22),
            .minYield = YIELD_RATE(8, 2, 2, 2),
    ...
    [BERRY_ID_LUM] =
    {
        .info = {
            ...
            .color = BERRY_COLOR_GREEN,
            .size = 34,
            .maxYield = YIELD_RATE(12, 5, 20, 18),
            .minYield = YIELD_RATE(8, 2, 3, 2),
            .description1 = COMPOUND_STRING("Slow to grow. If raised with loving"),
            .description2 = COMPOUND_STRING("care, it may grow many Berries."),
    ...
    [BERRY_ID_SITRUS] =
    {
        .info = {
            ...
            .color = BERRY_COLOR_YELLOW,
            .size = 95,
            .maxYield = YIELD_RATE(12, 5, 20, 27),
            .minYield = YIELD_RATE(8, 2, 3, 3),
    ...
    [BERRY_ID_FIGY] =
    {
        .info = {
            ...
            .color = BERRY_COLOR_RED,
            .size = 100,
            .maxYield = YIELD_RATE(8, 5, 15, 15),
            .minYield = YIELD_RATE(6, 1, 3, 3),
    ...
    [BERRY_ID_RAZZ] =
    {
        .info = {
            ...
            .color = BERRY_COLOR_RED,
            .size = 120,
            .maxYield = YIELD_RATE(12, 10, 15, 20),
            .minYield = YIELD_RATE(8, 2, 3, 4),
    ...
    [BERRY_ID_POMEG] =
    {
        .info = {
            ...
            .color = BERRY_COLOR_RED,
            .size = 135,
            .maxYield = YIELD_RATE(12, 5, 20, 26),
            .minYield = YIELD_RATE(8, 1, 1, 2),
            .description1 = COMPOUND_STRING("It grows into a generous crop"),
            .description2 = COMPOUND_STRING("of Berries with careful tending."),
    ...
    [BERRY_ID_CORNN] =
    {
        .info = {
            ...
            .color = OW_BERRY_COLORS == GEN_6_XY ? BERRY_COLOR_PURPLE : BERRY_COLOR_BLUE,
            .size = 75,
            .maxYield = YIELD_RATE(12, 10, 15, 15),
            .minYield = YIELD_RATE(8, 2, 3, 3),
    ...
    [BERRY_ID_SPELON] =
    {
        .info = {
            ...
            .size = 133,
            .maxYield = YIELD_RATE(12, 15, 15, 15),
            .minYield = YIELD_RATE(8, 2, 3, 3),
    ...
    [BERRY_ID_LIECHI] =
    {
        .info = {
            ...
            .size = 111,
            .maxYield = YIELD_RATE(12, 5, 10, 13),
            .minYield = YIELD_RATE(8, 2, 2, 2),
...
static u8 CalcBerryYield(struct BerryTree *tree)
{
    ...
    return RandomUniform(RNG_NONE, berryInfo->minYield, berryInfo->maxYield);
}
