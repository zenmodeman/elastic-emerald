...
const struct Berry gBerries[] =
{
    ...
    [ITEM_LUM_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .color = BERRY_COLOR_GREEN,
        .size = 34,
        .maxYield = YIELD_RATE(3, 5, 20, 18),
        .minYield = YIELD_RATE(2, 2, 3, 2),
    ...
    [ITEM_SPELON_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .color = BERRY_COLOR_RED,
        .size = 133,
        .maxYield = YIELD_RATE(3, 15, 15, 15),
        .minYield = YIELD_RATE(2, 2, 3, 3),
    ...
    [ITEM_ENIGMA_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .color = BERRY_COLOR_PURPLE,
        .size = 155,
        .maxYield = YIELD_RATE(10, 5, 5, 13),
        .minYield = YIELD_RATE(6,2,2,2),
    ...
    [ITEM_KEE_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .color = BERRY_COLOR_YELLOW,
        .size = 0,
        .maxYield = YIELD_RATE(4, 5, 10, 13),
        .minYield = YIELD_RATE(3, 2, 2, 2),
