...
const u8 gText_AbilityChangeExceedsTierPoints[] = _("Ability change exceeds\nTier Points cap!{PAUSE_UNTIL_PRESS}");
...
const u8 gText_NotReady[] = _("Not Ready");
...
const u8 gText_XNatureProbablyMetAt[] = _("{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5} nature, probably met at {LV_2}{DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1},\n{DYNAMIC 0}{DYNAMIC 4}{DYNAMIC 1}.\nTier Points: {DYNAMIC 6}");
...
const u8 gText_FoundItemWhileFishing[] = _("You found {STR_VAR_1} while fishing! {PAUSE_UNTIL_PRESS}");
...
const u8 gText_SkillPageSave[] = _("A: SAVE");
const u8 gText_SkillPageBack[] = _("B: BACK");
