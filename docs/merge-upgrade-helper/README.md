...
- The current uncommitted tutor-data parser repair corrects the Tech Tutor six-badge array's integer type and restores terminators on the final three Resource Mode TM-trade arrays.
