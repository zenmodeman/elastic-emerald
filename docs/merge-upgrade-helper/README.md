...
- Latest commit whose applicable project changes have been reviewed for this dossier: `b21e72f566` (`Additional Drain Douse tests`).
- Applicable work after that boundary: uncommitted fourth regression batch adding twenty mode, progression, item-clause, ability, and move-mechanic scenarios described below.
