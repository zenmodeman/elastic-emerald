...
- Latest commit whose applicable project changes have been reviewed for this dossier: `4ed343f5a8` (`Add some more tests of custom features`).
- Applicable work after that boundary: uncommitted restoration of Elastic Emerald's 40% Big Root bonus, updated native Big Root expectations, and the ten additional Drain Douse boundary tests described below.
