...
#define AI_FLAG_HEAVY_SWITCHING             AI_FLAG(34)  // Reserved legacy flag; the separate heavy-switching path is currently suppressed.
...
#define AI_FLAG_SMART_TRAINER         (AI_FLAG_BASIC_TRAINER | AI_FLAG_SMART_SWITCHING | AI_FLAG_SMART_MON_CHOICES | AI_FLAG_PREDICTION | AI_FLAG_ASSUMPTIONS | AI_FLAG_SMART_TERA | AI_FLAG_RANDOMIZE_SWITCHIN)
