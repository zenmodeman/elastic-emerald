...
#define VAR_REMAINING_RELEARNER                          0x4083 // Number of remaining Relearner moves in Resource mode
...
#define VAR_REMAINING_TUTOR                              0x4091 // Number of remaining Tutor moves in Resource mode
