...
#define VAR_TRAINER_SCHOOL_STATE                         0x404E // Used for Trainer School scene; formerly Un used Var
...
#define VAR_REMAINING_RELEARNER                          0x4083 // Number of remaining Relearner moves in Resource mode, formerly un used
...
#define VAR_MONOTYPE                                     0x408B // For monotype settings, formerly un used
#define VAR_LITTLEROOT_HOUSES_STATE_BRENDAN              0x408C
#define VAR_LITTLEROOT_RIVAL_STATE                       0x408D
#define VAR_BOARD_BRINEY_BOAT_STATE                      0x408E
#define VAR_DEVON_CORP_3F_STATE                          0x408F
#define VAR_BRINEY_HOUSE_STATE                           0x4090
#define VAR_REMAINING_TUTOR                              0x4091 // Number of remaining Tutor moves in Resource mode, formerly un used
...
#define VAR_SUCTION_CUPS                                 0x409B //State for which suction cups item to get, formerly un used
#define VAR_ELITE_4_STATE                                0x409C
#define VAR_MIRAGE_ISLAND_SPECIES                        0x409D // Species selected for the current in-game day.
#define VAR_MOSSDEEP_SPACE_CENTER_STAIR_GUARD_STATE      0x409E
#define VAR_MOSSDEEP_SPACE_CENTER_STATE                  0x409F
#define VAR_SLATEPORT_HARBOR_STATE                       0x40A0
#define VAR_MIRAGE_ISLAND_ROLL_DAY                       0x40A1 // VAR_DAYS + 1 when the daily species was selected.
...
#define VAR_MIRAGE_ISLAND_ENCOUNTER_DAY                  0x40A8 // VAR_DAYS + 1 after today's encounter is consumed.
