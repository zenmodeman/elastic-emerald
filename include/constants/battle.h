...
#define BATTLE_TYPE_AI_VS_AI           (1 << 28) // Formerly BATTLE_TYPE_28
#define BATTLE_TYPE_GHOST              (1 << 29)
#define BATTLE_TYPE_POKEDUDE           (1 << 30)
...
#define VOLATILE_DEFINITIONS(F) \
    ...
    F(VOLATILE_FOREWARN_MOVE,               forewarnMove,                  (enum Move, MOVES_COUNT_ALL - 1)) \
