...
enum StringID
{
    ...
    STRINGID_MUDSPORTPREVENTS,
    STRINGID_WATERSPORTPREVENTS,
    STRINGID_DRAINDOUSESETSDRAINING,
    STRINGID_DRAINEDWITHLIQUID,
    STRINGID_PLAYERWHITEOUT3,
    STRINGID_ILLUMINATING,
    STRINGID_DAMP_HEALING,
    STRINGID_MERRY,
    STRINGID_CAUGHTMONEXCEEEDSPOINTS,
    STRINGID_COUNT
};
