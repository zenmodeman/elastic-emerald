...
struct ProtectStruct
{
    ...
    u32 monHurt:1; //taking one of the 8 unused bits; Attempt to capture that the user took damage from things such as Life Orb
    u32 unused:7;
...
struct AiLogicData
{
    ...
    u8 doublesKoTargets[MAX_BATTLERS_COUNT]; //Stores what target the AI has determined to KO per battler, calculated only once
