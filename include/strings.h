...
extern const u8 gText_TeachWhichMoveToPkmn_Resource[];
extern const u8 gText_TeachWhichMoveToPkmn_FreeRelearner[];
...
extern const u8 gText_AbilityChangeExceedsTierPoints[];
...
extern const u8 gText_NotReady[];
...
extern const u8 gText_FoundItemWhileFishing[];
extern const u8 gText_SkillPageSave[];
extern const u8 gText_SkillPageBack[];
