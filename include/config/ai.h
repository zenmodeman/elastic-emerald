...
#define SHOULD_SWITCH_ABSORBS_MOVE_PERCENTAGE                       50 //Prevent the absorbing percentage from being guarenteed
...
#define AI_BAD_SCORE_THRESHOLD                                  98 // Move scores beneath this threshold are considered "bad" when deciding switching
...
#define PREDICT_SWITCH_CHANCE                                   50 // Primary RNG gate for AI switch prediction, including immunity-switch prediction.
