...
#define B_FLAG_AI_VS_AI_BATTLE      FLAG_AI_AI_BATTLE // Elastic Emerald runtime toggle.
#define B_FLAG_DYNAMAX_BATTLE       0     // If this flag is set, the ability to Dynamax in battle is enabled for all trainers.
#define B_FLAG_TERA_ORB_CHARGED     FLAG_TERA_CHARGED
#define B_FLAG_TERA_ORB_NO_COST     FLAG_TERA_CHARGED
...
#define B_OVERWORLD_SNOW                GEN_8
#define B_SNOW_WARNING                  GEN_8
...
#define B_OBEDIENCE_MECHANICS           GEN_7
