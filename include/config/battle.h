...
#define B_ABILITY_TRIGGER_CHANCE    GEN_3      //Setting to gen 3 values to work better with my RNG fallbacks 
                                               //In Gen3, Shed Skin, Cute Charm, Flame Body, Static and Poison Point have a 1/3 chance to trigger. In Gen 4+ it's 30%.
...
#define B_FLAG_AI_VS_AI_BATTLE      FLAG_AI_AI_BATTLE     // If this flag is set, the player's mons will be controlled by the ai next battles.
...
//Setting the cost to Tera_Charged to effectively set it to set.
#define B_FLAG_TERA_ORB_NO_COST     FLAG_TERA_CHARGED     // If this flag is set, the Tera Orb does not use up its charge upon Terastallization. In S/V, this occurs after an event with Terapagos.
